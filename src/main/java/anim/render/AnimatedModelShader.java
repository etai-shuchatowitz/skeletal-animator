...
import engine.shaders.uniforms.UniformMat4Array;
import engine.shaders.uniforms.UniformMatrix;
import engine.shaders.uniforms.UniformSampler;
import engine.shaders.uniforms.UniformVec3;
...
public class AnimatedModelShader extends ShaderProgram {
    ...
    private static final MyFile VERTEX_SHADER = new MyFile("src/main/java/anim/render/animatedEntityVertex.glsl");
    private static final MyFile FRAGMENT_SHADER = new MyFile("src/main/java/anim/render/animatedEntityFragment.glsl");
